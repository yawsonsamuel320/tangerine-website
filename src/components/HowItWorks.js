      ...
      <div className="how-container">
        ...
        <div className="steps">
          <div className="step">
            ...
            <p>Get our mobile app on your iPhone or Android phone</p>
          </div>

          <div className="step">
            <span className="number">2</span>
            <h3>Select Your Items</h3>
            <p>Search for and select the shopping items you need</p>
          </div>

          <div className="step">
            <span className="number">3</span>
            <h3>Delivered at Your Door</h3>
            <p>Track your order and have it delivered at your doorstep</p>
          </div>
        </div>
